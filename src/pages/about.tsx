            ...
            <div className="relative flex h-screen justify-start items-center z-30">
                <div className="container mx-auto flex flex-col md:flex-row mt-10">
                    ...
                    <div className="w-full md:w-6/12 px-7 mt-16">
                        <h1 className="text-white text-3xl md:text-4xl mb-5 capitalize">About <span className="font-bold text-5xl">MyCompany</span></h1>
                        <p className="text-white text-sm md:text-md text-justify leading-5 md:leading-6">{`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. `}</p>
